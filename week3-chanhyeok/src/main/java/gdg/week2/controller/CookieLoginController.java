...
public class CookieLoginController {
    ...
    // 유저 정보 확인 api
    @GetMapping("/info")
    public ResponseEntity<?> loginCheckapi(@CookieValue(value = "userId", required = false) Long userId) {
        ...
        @GetMapping("/admin")
        public ResponseEntity<String> checkAdmin(@CookieValue(value = "userId", required = false) Long userId) {
