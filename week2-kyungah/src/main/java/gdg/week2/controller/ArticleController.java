...
public class ArticleController {
    ...
    @GetMapping("/articles-by-author/{author}")
    public List<ArticleResponseDto> getArticlesByAuthorPath(@PathVariable String author) {
        List<ArticleResponseDto> response = articleService.getArticlesByAuthor(author);
        return response;
    }
    ...
    public ResponseEntity<String> deleteAllArticles() {
        ...
        return ResponseEntity.status(HttpStatus.NO_CONTENT).body("All articles deleted successfully");
    }
    //4. pathVariable 방법
    @DeleteMapping("/article-path/{id}")
